...
async function checkAutoFadeTrigger(deckId) {
  ...
  // Trigger fadeDuration timecode-seconds before track end.
  // At rates != 1.0 this means slightly different real-time durations,
  // which is acceptable (Option A: consistent timecode throughout).
